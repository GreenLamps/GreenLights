...
@Component({
    selector: 'jhi-category-green-lights',
    templateUrl: './category-green-lights.component.html'
})
export class CategoryGreenLightsComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: CategoryGreenLights) {
        return item.id;
    }
