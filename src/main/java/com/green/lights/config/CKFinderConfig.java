...
/**
 * Created by SterOtto on 2017/5/24.
 */
public class CKFinderConfig extends Configuration {
    private static final Logger logger = LoggerFactory.getLogger(CKFinderConfig.class);
    ...
    public void init() throws Exception {
        ...
        logger.debug("xmlFilePath is {}", this.xmlFilePath);
