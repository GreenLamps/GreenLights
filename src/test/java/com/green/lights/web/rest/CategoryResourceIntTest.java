...
import com.green.lights.repository.CategoryRepository;
import com.green.lights.service.CategoryService;
import com.green.lights.repository.search.CategorySearchRepository;
import com.green.lights.service.dto.CategoryDTO;
import com.green.lights.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getState()).isEqualTo(DEFAULT_STATE);
        assertThat(testCategory.getCreateTime()).isEqualTo(DEFAULT_CREATE_TIME);
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getState()).isEqualTo(UPDATED_STATE);
        assertThat(testCategory.getCreateTime()).isEqualTo(UPDATED_CREATE_TIME);
